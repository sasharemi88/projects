...
class DostSpider(scrapy.Spider):
    name = 'DostSpider'
    allowed_domains = ["www.tripadvisor.ru"]
    pgn = 30
    start_urls = ["https://www.tripadvisor.ru/Attractions-g2324055-Activities-Samara_Oblast_Volga_District.html"]
    ...
    def parse(self, response):
        if response.url not in self.visited_urls:
            ...
            next_page_url = "https://www.tripadvisor.ru/Attractions-g2324049-Activities-oa" + str(self.pgn) + "-Nizhny_Novgorod_Oblast_Volga_District.html"
